...
#define func_name fma256_noncblas_sgemm_nt5
#define tune_name fma256_noncblas_sgemm_nt5_tune
...
enum {
 ...
 M_STEP                  = 45,
 N_STEP_MULTIPLIER       = 3,
 N_SUPER_STEP_MULTIPLIER = 16,
};

#include "avxnnn_noncblas_sgemm_nt5_unroll4.c"
